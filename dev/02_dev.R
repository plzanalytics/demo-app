...
golem::add_module(name = "instruction", with_test = F) # Name of the module
golem::add_module(name = "dashboard", with_test = F) # Name of the module
golem::add_module(name = "download", with_test = F) # Name of the module
...
## Vignette ----
usethis::use_vignette("RockandRose")
